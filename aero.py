...
condicionamento['baixo_medio'] = fuzz.trimf(condicionamento.universe, [20.5, 29.5, 38.5])
condicionamento['medio'] = fuzz.trimf(condicionamento.universe, [29.5, 38.5, 47.5])
condicionamento['medio_alto'] = fuzz.trapmf(condicionamento.universe, [38.5, 47.5, 56.5, 56.5])
...
regra6 = ctrl.Rule(tempo_disponivel['muito'] & condicionamento['alto'], intensidade['media_alta'])
regra7 = ctrl.Rule(tempo_disponivel['muito'] & condicionamento['medio_alto'], intensidade['media'])
regra8 = ctrl.Rule(tempo_disponivel['muito'] & condicionamento['medio'], intensidade['baixa_media'])
regra9 = ctrl.Rule(frequencia['baixa'] & condicionamento['alto'], intensidade['alta'])
regra10 = ctrl.Rule(frequencia['baixa'] & condicionamento['medio_alto'], intensidade['alta'])
regra11 = ctrl.Rule(frequencia['baixa'] & condicionamento['medio'], intensidade['media_alta'])
regra12 = ctrl.Rule(frequencia['baixa'] & condicionamento['baixo_medio'], intensidade['media'])
regra13 = ctrl.Rule(frequencia['baixa'] & condicionamento['baixo'], intensidade['baixa_media'])
regra14 = ctrl.Rule(tempo_disponivel['pouco'] & condicionamento['alto'], intensidade['alta'])
regra15 = ctrl.Rule(tempo_disponivel['pouco'] & condicionamento['medio_alto'], intensidade['alta'])
regra16 = ctrl.Rule(tempo_disponivel['pouco'] & condicionamento['medio'], intensidade['media_alta'])
regra17 = ctrl.Rule(tempo_disponivel['pouco'] & condicionamento['baixo_medio'], intensidade['media'])
regra18 = ctrl.Rule(tempo_disponivel['pouco'] & condicionamento['baixo'], intensidade['baixa_media'])
regra19 = ctrl.Rule(frequencia['alta'] & condicionamento['alto'], intensidade['media_alta'])
regra20 = ctrl.Rule(frequencia['alta'] & condicionamento['medio_alto'], intensidade['media'])
regra21 = ctrl.Rule(frequencia['alta'] & condicionamento['medio'], intensidade['baixa_media'])
regra22 = ctrl.Rule(frequencia['alta'] & condicionamento['baixo_medio'], intensidade['baixa'])
...
regra25 = ctrl.Rule(adesao['alta'] & condicionamento['medio'], intensidade['media_alta'])
regra26 = ctrl.Rule(adesao['alta'] & condicionamento['baixo_medio'], intensidade['media'])
regra27 = ctrl.Rule(adesao['alta'] & condicionamento['baixo'], intensidade['baixa_media'])
regra28 = ctrl.Rule(adesao['baixa'] & condicionamento['alto'], intensidade['media_alta'])
regra29 = ctrl.Rule(adesao['baixa'] & condicionamento['medio_alto'], intensidade['media'])
regra30 = ctrl.Rule(adesao['baixa'] & condicionamento['medio'], intensidade['baixa_media'])
regra31 = ctrl.Rule(adesao['baixa'] & condicionamento['baixo_medio'], intensidade['baixa'])
regra32 = ctrl.Rule(adesao['moderada'] & condicionamento['alto'], intensidade['alta'])
regra33 = ctrl.Rule(adesao['moderada'] & condicionamento['medio_alto'], intensidade['media_alta'])
regra34 = ctrl.Rule(adesao['moderada'] & condicionamento['medio'], intensidade['media'])
regra35 = ctrl.Rule(adesao['moderada'] & condicionamento['baixo_medio'], intensidade['baixa_media'])
regra36 = ctrl.Rule(adesao['moderada'] & condicionamento['baixo'], intensidade['baixa'])
regra37 = ctrl.Rule(excesso_peso['moderado'] & condicionamento['baixo'], intensidade['baixa_media'])
regra38 = ctrl.Rule(excesso_peso['moderado'] & condicionamento['baixo_medio'], intensidade['media'])
regra39 = ctrl.Rule(excesso_peso['moderado'] & condicionamento['medio'], intensidade['media_alta'])
regra40 = ctrl.Rule(excesso_peso['moderado'] & condicionamento['medio_alto'], intensidade['alta'])

intensidade_ctrl = ctrl.ControlSystem([
    regra1, regra2, regra3, regra4, regra5, regra6, regra7, regra8, regra9, regra10, regra11, regra12, regra13, regra14,
    regra15, regra16, regra17, regra18, regra19, regra20, regra21, regra22, regra23, regra24, regra25, regra26, regra27,
    regra28, regra29, regra30, regra31, regra32, regra33, regra34, regra35, regra36, regra37, regra38, regra39, regra40
])
