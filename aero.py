...
rule33 = ctrl.Rule(
    adherence["moderate"] & fitness["medium_high"], intensity["medium_high"]
)
rule34 = ctrl.Rule(adherence["moderate"] & fitness["medium"], intensity["medium"])
rule35 = ctrl.Rule(
    adherence["moderate"] & fitness["low_medium"], intensity["low_medium"]
)
...
rule38 = ctrl.Rule(
    excess_weight["moderate"] & fitness["low_medium"], intensity["medium"]
)
rule39 = ctrl.Rule(
    excess_weight["moderate"] & fitness["medium"], intensity["medium_high"]
)
rule40 = ctrl.Rule(
    excess_weight["moderate"] & fitness["medium_high"], intensity["high"]
)
